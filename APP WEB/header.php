...
<div class="header">
	<div class="logo">
		<img src="img/logo1.png" alt="" class="logo_image" >
		<img src="img/logo3.jpg.jpeg" alt="" class="logo_image2" >
		<img src="img/logo4.png" alt="" class="logo_image3" >
...
<div class="topnav" id="myTopnav">
    ...
    <a href="ManageUsers.php" id="a1">Users</a>
    <a href="index.php">Presence</a>
    ...
    <div class="modal-content">
      ...
      <form action="ac_update.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-body">
	      	...
	      	<label for="User-psw"><b>Your Password </b></label>
